...
plot(
  ...
  pch = 19,
  col = "darkblue",
  main = "Number of Genes vs. Number of Intronic Mutations",
  ylab = "Number of Genes",
  xlab = "Number of Intronic Mutations",
...
# Print model summary and correlation
cat("Correlation between number of genes and mutations:", 
    cor(gene_mutation_data$NumGenes, gene_mutation_data$NumMutations), "\n")
print(summary(model))

# Additional analysis: genes per mutation ratio
gene_mutation_data$GenesPerMutation <- gene_mutation_data$NumGenes / gene_mutation_data$NumMutations
print("Genes per mutation ratio:")
print(gene_mutation_data[, c("Chromosome", "GenesPerMutation")])